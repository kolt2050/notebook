    ...
    strings: {
        EN: {
          ...
          confirm_import_text: "This will overwrite all current documents. Are you sure?",
            ...
            export_md: "Export single document to MD",
            export_doc_pdf: "Export single document to PDF",
            delete_btn: "Delete",
            modal_cancel: "Cancel",
        ...
        RU: {
          ...
          confirm_import_text: "Это ПОЛНОСТЬЮ ПЕРЕЗАПИШЕТ текущие данные. Вы уверены?",
            ...
            export_all: "Экспортировать всё в MD",
            ...
            export_md: "Экспорт одного документа в MD",
            export_doc_pdf: "Экспорт одного документа в PDF",
            delete_btn: "Удалить",
            modal_cancel: "Отмена",
            modal_confirm: "Ок",
